 ...
 */
Material = function(kAmbient, kDiffuse, kSpecular, shininess, drawWithPhong) {

	this.kAmbient = kAmbient;
	this.kDiffuse = kDiffuse;
	this.kSpecular = kSpecular;
	this.shininess = shininess;
	this.drawWithPhong = drawWithPhong;
	...
	this.setUniforms = function(program, modelViewMatrix) {
		...
		program.setUniform("material.drawWithPhong", "int", this.drawWithPhong);
