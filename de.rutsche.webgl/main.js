...
initScene = function() {
	...
	this.earthMaterial = new Material([0.3, 0.3, 0.3], [0.0, 0.6, 0.0], [0.8, 0.8, 0.8], 250, 0);

	// TODO: make the magic happen: WorldSphere!
	// Sphere to symbolize the earth
	this.earth = new Sphere(gl, 0.5, 100, 100, [1, 1, 0], [1, 0, 0]);
}
/*
 drawScene()
...
drawScene = function() {
	...
	if(this.showLights)
		this.nightTexture.makeActive(program, "nightTexture", 0);
